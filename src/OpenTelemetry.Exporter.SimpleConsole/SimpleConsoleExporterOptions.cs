...
public class SimpleConsoleExporterOptions
{
    ...
    public int TraceIdLength
    {
        ...
        set
        {
            if (value < 1)
            {
                throw new ArgumentOutOfRangeException(nameof(value), "TraceIdLength must be at least 1");
            }

            if (value > 32)
            {
                throw new ArgumentOutOfRangeException(nameof(value), "TraceIdLength cannot exceed 32");
            }
